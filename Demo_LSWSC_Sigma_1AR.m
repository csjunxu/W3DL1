...
for lambda = [150]
    ...
    for i = 1 : im_num
        ...
        %% output
        imname = sprintf(['C:/Users/csjunxu/Desktop/NIPS2017/W3Results/WSC/LSWSC_1AR_CC15_l' num2str(Par.lambda) '_'  TT_im_dir(i).name]);
    ...
    mCCPSNR = mean(CCPSNR);
    mCCSSIM = mean(CCSSIM);
    save(['C:/Users/csjunxu/Desktop/NIPS2017/W3Results/LSWSC_1AR_delta' num2str(Par.delta) '_ps' num2str(Par.ps) '_step' num2str(Par.step) '_nlspini' num2str(Par.nlspini) '_nlspgap' num2str(Par.nlspgap) '_l' num2str(Par.lambda) '.mat'],'alltime','mtime','PSNR','mPSNR','SSIM','mSSIM','CCPSNR','mCCPSNR','CCSSIM','mCCSSIM');
end